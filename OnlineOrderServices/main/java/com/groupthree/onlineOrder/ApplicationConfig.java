...
public class ApplicationConfig {
    ...
    public LocalSessionFactoryBean sessionFactory() {
        String PACKAGE_NAME = "com.groupthree.onlineOrder.entity";
    ...
    public DataSource dataSource() {
        String RDS_ENDPOINT = "laiproject-onlineorder-database.cn8zmy1phc70.us-east-2.rds.amazonaws.com";
        String USERNAME = "admin";
        String PASSWORD = "Sehrschon688";
